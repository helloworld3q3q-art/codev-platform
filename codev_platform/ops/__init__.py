...
def register_all(subparsers) -> None:
    ...
    """
    for modname in ("reindex", "reindex_queue", "reindex_maintenance", "index_status", "webhook", "gateway", "health", "hooks", "agent", "codegraph", "memory_db", "org", "backup", "bootstrap", "metrics", "logs", "onboard", "runtime"):
        try:
