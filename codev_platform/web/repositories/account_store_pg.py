...
_PgBase = SqlAlchemyRepositoryBase
_upsert_stmt = build_upsert_statement


class PgOrgStore(_PgBase):
    _required_tables = (tables.orgs,)
...
class PgUserStore(_PgBase):
    _required_tables = (tables.users, tables.org_members)
...
class PgMemberStore(_PgBase):
    _required_tables = (tables.org_members,)
