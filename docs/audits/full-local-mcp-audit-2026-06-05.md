...
```text
platform-docs  -> https://example.invalid/reference
codegraph      -> https://example.invalid/reference
agent-memory   -> https://example.invalid/reference
graph          -> https://example.invalid/reference
```
