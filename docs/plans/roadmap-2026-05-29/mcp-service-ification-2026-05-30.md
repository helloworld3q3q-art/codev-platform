...
"platform": { "url": "https://example.invalid/reference" },     // 平台服务基址(已有)
"mcp": {
  "codegraph_sse": "https://example.invalid/reference",          // P3 端口
  "cross_link_sse": "https://example.invalid/reference"          // P2 端口
},
"projects": {
  "openclaw-stock": { "codegraph_api_url": "https://example.invalid/reference", "codegraph_sse_port": 18085 }
}
```
