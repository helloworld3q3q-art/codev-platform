...
调研 [supermemory](https://github.com/supermemoryai/supermemory) —— 一个**通用记忆 API 产品**(SaaS + 可自托管),与本平台 M1-M5 记忆引擎设计**高度重叠**:scope 作用域、supersede(替代)、forget(遗忘)、TTL、冲突策略、混合召回(向量 + 关键词)。`mem0`(github.com/mem0ai/mem0)同类。
