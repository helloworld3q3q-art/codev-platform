...
```json
{ "memory": { "pg_dsn": "postgresql://codev_platform@127.0.0.1:5432/codev_platform_memory", "pg_dsn_read": null } }
```
...
[Service]
Type=oneshot
Environment=CODEV_PLATFORM_MEMORY_DSN=postgresql://codev_platform:<pw>@127.0.0.1/codev_platform_memory
ExecStart=/home/helloworld/work/codev-platform/.venv/bin/codev-platform backup --keep 7
...
```cron
0 3 * * * CODEV_PLATFORM_MEMORY_DSN='postgresql://...' /home/helloworld/work/codev-platform/.venv/bin/codev-platform backup --keep 7
```
