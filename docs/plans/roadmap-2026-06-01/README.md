# roadmap-2026-06-01 - 模块化核心 + 插件化扩展规划(🗄️ 已归档 / 交付+详细 plan 真值源)

> **🗄️ 归档说明(2026-06-03 起)**:本目录转为**交付归档 + 各 Track 详细实施 plan 真值源**,
> 保持不动(只补链接/笔误)。新发现的任务进当前主目录,不在此新增。
>
> **当前主目录 → [`../roadmap-2026-06-03/`](../roadmap-2026-06-03/)**(图谱收敛 → 影响分析 → 平台收尾)。
> 本目录的 web-backend / agent-memory / pluginized / refactor / sqlalchemy 详细 plan 仍是各 Track 实施真值源,
> 由新迭代 `next-plan-2026-06-03.md` 排序+追踪。
