...
# 2. 装依赖(用户手动)
pnpm --dir D:\WorkSpace\codev-platform\web-ui install

# 3. 验证 TS1139 是否消失 + 暴露的自身类型错清单
pnpm --dir D:\WorkSpace\codev-platform\web-ui run tsc

# 4. 回归构建(确认 umi/max 在 TS5 下正常)
pnpm --dir D:\WorkSpace\codev-platform\web-ui run build
```
