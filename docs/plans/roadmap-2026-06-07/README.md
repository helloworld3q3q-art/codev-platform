...
| [next-steps-2026-06-09.md](next-steps-2026-06-09.md) | 接下来做什么: 审计剩余项(#10 ✅ 已修 / #7 ✅ config DI 已实现+测 / #8 set_roles 多 org 延后)+ 三梯队整体剩余计划 + 新窗口开局动作 | ✅ 完成(#10/#7 已做; 仅 #8 安全敏感刻意延后; 三梯队真活 2026-06-12 已清) |
