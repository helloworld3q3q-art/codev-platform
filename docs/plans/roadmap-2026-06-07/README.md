...
| [multi-repo-contract-bridge-plan-2026-06-10.md](multi-repo-contract-bridge-plan-2026-06-10.md) | 多仓项目跨层链路: operationId 契约桥(4 专家面板收敛; Phase 1 契约桥+漂移立即做, Phase 2 多根索引冻结到 Gate) | 计划(待起 Phase 1) |
