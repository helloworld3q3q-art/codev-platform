...
| [daily-summary-2026-07-07.md](daily-summary-2026-07-07.md) | P3 审计修复 + 运行治理 + Web/MCP fan-out:tagged file tools、rerank extra ref、PG queue fail-closed、extra repo webhook 体检、fan-out 指标/告警、Web codegraph 多仓读侧、外部 codegraph MCP 代理分仓合并、真实 ideas E2E、recall_code 主仓缺索引降级修复、codegraph status Junction 判定回归测试 | 日报 |
...
| 4 | **P3 多仓多根索引** ✅**核心 fan-out 闭环完成**(`0812b8b`/`0a94264`/`d00de6f` + 2026-07-07 tagged path/rerank/fallback/queue/health/metrics/Web GraphAPI/codegraph MCP 代理补齐;剩真实多仓 E2E 验收)| 重 | roadmap-2026-06-10 多仓 Phase 2(解冻)|
