...
| 4 | **P3 多仓多根索引** ✅**首批已交付**(`0812b8b`/`0a94264`/`d00de6f`:code_vec+recall fan-out、extra repo 反向触发、agent codegraph 工具跨仓查询;Web GraphAPI/MCP 代理待后续)| 重 | roadmap-2026-06-10 多仓 Phase 2(解冻)|
