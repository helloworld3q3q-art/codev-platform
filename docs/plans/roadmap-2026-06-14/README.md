...
| [daily-summary-2026-07-08.md](daily-summary-2026-07-08.md) | OMS 真实 Java 后端解析收口:增强 `builtin.backend_spring` 支持接口方法写 mapping、Controller 实现类承载 handler 的 Spring 结构;bridge 使用 `controller_file` 从实现类起跳;DSM graph `backend_spring` 0→3 且 audit clean | 日报 |
