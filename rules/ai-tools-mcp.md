...
> **完整说明** —— `docs/dev-evolution/ai-toolchain-guide.md`（架构原理 / 模型细节 / 故障手册 / 升级路线 全在那里）
...
**完整故障表** + 模型升级历程 + JSONL 召回日志分析 + A/B test 工具 等见 `docs/dev-evolution/ai-toolchain-guide.md` §14。
