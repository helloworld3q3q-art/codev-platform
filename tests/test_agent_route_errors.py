...
def test_chat_invalid_project_id_400_no_raw_leak(monkeypatch):
    ...
    d = _assert_code(r, 400, ErrorCode.INVALID_PARAMS)
...
def test_chat_upstream_unavailable_503_no_raw_leak(monkeypatch):
    secret = "OPENAI_API_KEY=sk-deadbeef missing in config"
...
def _mem_client(monkeypatch, *, store=_FakeStore(), allowed=True):
