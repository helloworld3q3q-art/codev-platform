...
def test_usage_codegraph_counts_calls(tmp_path):
    ...
    _write_jsonl(cg, [
        {"ts": "2999-01-01T10:00:00", "project_id": "p", "tool": "codegraph_search", "ok": True, "elapsed_ms": 12.0},
        {"ts": "2999-01-01T10:01:00", "project_id": "p", "tool": "codegraph_search", "ok": True, "elapsed_ms": 8.0},
        {"ts": "2999-01-01T10:02:00", "project_id": "p", "tool": "codegraph_status", "ok": False, "elapsed_ms": 4.0},
    ])
    r = Report()
...
def test_platform_usage_7d_aggregates_codegraph(tmp_path):
    """_usage_7d 把 codegraph_usage.jsonl 按 project_id 计入 'codegraph' key。"""
    from codev_platform import platform_status

    cg = tmp_path / "codev_platform" / "codegraph" / "codegraph_usage.jsonl"
    _write_jsonl(cg, [
        {"ts": "2999-01-01T10:00:00", "project_id": "openclaw-stock", "tool": "codegraph_search", "ok": True},
        {"ts": "2999-01-01T10:01:00", "project_id": "openclaw-stock", "tool": "codegraph_impact", "ok": True},
    ])
    usage = platform_status._usage_7d(tmp_path)
