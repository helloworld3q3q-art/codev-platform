...
项目使用 antd `^6.3.1`，多个 props 已废弃。**完整清单 + 修复模板 + grep 自检** 见 `.codex/rules/antd6-adapt.md`（含 Card.classNames.root / Statistic.styles.content / Alert.title / destroyOnHidden / Modal.confirm → showConfirm / Select.showSearch 对象形式 等 7 类）。
