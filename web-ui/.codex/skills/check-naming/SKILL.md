---
name: web-ui-check-naming
description: 检查 web-ui 组件和页面文件命名是否符合 component-naming 规范。
---
...
检查项目中的文件命名是否符合规范。命名规则定义见 `.codex/rules/component-naming.md`，本 skill 只负责执行检查。
...
`.codex/rules/component-naming.md`
