...
const getMenuItems = (tabsLength: number) => [
  { key: 'refresh', label: i18nMessages('refresh', '刷新'), icon: <ReloadOutlined /> },
  { type: 'divider' as const },
  { key: 'close', label: i18nMessages('close', '关闭'), disabled: tabsLength <= 1 },
  { key: 'closeOther', label: i18nMessages('closeOthers', '关闭其他'), disabled: tabsLength <= 1 },
  { key: 'closeRight', label: i18nMessages('closeRight', '关闭右侧') },
  { type: 'divider' as const },
  { key: 'closeAll', label: i18nMessages('closeAll', '关闭所有') },
];
