...
const Footer: React.FC = () => {
  return (
    <div className="py-8 text-12 color-#939393 text-center bg-#222222">
      准时达国际供应链管理有限公司版权所有{' '}
      <a
        target="_blank"
        rel="noreferrer"
        href="https://beian.miit.gov.cn"
        className="color-#939393 px-10 no-underline hover:color-primary"
      >
        蜀ICP备 2024058509号-6
      </a>
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=51019002002869"
        className="color-#939393 px-10 no-underline hover:color-primary"
      >
        川公网安备 51019002002869号
      </a>
    </div>
  );
};
